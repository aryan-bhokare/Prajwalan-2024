...
function NFTCard(props) {
  ...
  return (
    <> 
<div className='flex group flex-col space-y-4 rounded-lg overflow-hidden border border-slate-400/10 pb-8 hover:shadow-xl duration-500 ease-in-out hover:shadow-white/10 relative h-[320px] w-[328px]'>
        {/* Image & Counter */}
       
        <div className='flex flex-col items-center justify-center relative'>
    <img src={eventDetails.logo} alt={eventDetails.event_name} className='object-cover h-[250px] w-[278px]' />
</div>
        {/* Content */}
        <div className='px-6 flex flex-col m '>
          {/* Title */}
          <h1 className='text-xl mx-auto'>  {eventDetails.event_name}</h1>
